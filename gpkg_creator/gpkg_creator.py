...
class GpkgCreator(QDialog):
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&DBGI Geopackage Creator')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GpkgCreator', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/gpkg_creator/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Create a DBGI geopackage'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginVectorMenu(
                self.tr(u'&DBGI Geopackage Creator'),
                action)
